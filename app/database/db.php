...
/*display values of functions*/
function dd($value) //TODO :: delete once done
{
...
function selectAll($table, $conditions = [])
{
    ...
    if(empty($conditions))
    {
        ...
        //return records that match given conditions
/*        $sql = " SELECT * FROM $table WHERE username = 'David' AND admin = 1";*/
        $i = 0;
